      ...
      <div className="flex flex-col gap-4 rounded-xl border border-brand-border bg-white p-4 shadow-sm sm:flex-row sm:flex-wrap sm:items-end">
        <div className="min-w-[180px] flex-1">
          ...
          <select
            ...
            className="mt-1.5 w-full rounded-lg border border-brand-border bg-white px-3 py-2.5 text-brand-charcoal"
          >
        ...
        <div className="min-w-[180px] flex-1">
          ...
          <input
            ...
            className="mt-1.5 w-full rounded-lg border border-brand-border bg-white px-3 py-2.5 text-brand-charcoal placeholder:text-brand-muted/60"
          />
        </div>
        <button
          type="button"
